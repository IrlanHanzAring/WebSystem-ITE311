        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary rounded mb-4">
            <div class="container-fluid">
                ...
                <div class="navbar-nav">
                    <a class="nav-link active text-white bg-secondary rounded" href="<?= base_url() ?>">Home</a>
            ...
            <div class="col-md-8">
                <div class="card border-primary">
                    <div class="card-body bg-light">
                        <h1 class="card-title text-primary">Home Page</h1>
                        <p class="card-text">Welcome to the Home page of my Web System!</p>
                    </div>
                </div>
            </div>
        </div>
